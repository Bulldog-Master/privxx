...
func (s *Server) handleSendMessage(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, contracts.SendMessageResult{V: contracts.ContractVersionV1, Ok: true, Accepted: true})
}
...
func (s *Server) handleMessagesInbox(w http.ResponseWriter, r *http.Request) {
	...
	msgs := phase7Store.ListMessages(req.ConversationID, "", req.Limit)
