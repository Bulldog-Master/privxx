...
// Bridge API URL (api.privxx.app serves JSON API, privxx.app serves frontend)
export const BRIDGE_API_URL = 'https://api.privxx.app';
export const BRIDGE_BASE_URL = import.meta.env.VITE_BRIDGE_URL || BRIDGE_API_URL;
